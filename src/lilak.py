    ...
    def pars_main_dic(self):
        ...
        ### Noun ########################################################################################
                    ...
                    if word.endswith(PERSIAN_HE):
                        ...
                        label += 'sa'   # زندگیم، زندگیت، زندگیش، زندگیمان، زندگیتان، زندگیشان
                    ...
                    if word.endswith(PERSIAN_HE):
                        ...
                        label += 'sa'   # فناویم، فناویت، فناویش، فناویمان، فناویتان، فناویشان
                    ...
                    if word.endswith(PERSIAN_HE):
                        ...
                        label += 'sa'   # مهدیم، مهدیت، مهدیش، مهدیمان، مهدیتان، مهدیشان
                        ...
                        if kam_dandane:
                            label += 'sd'   # پیروزیها
                                            # پیروزیهای
                                            # پیروزیهایی
                            label += 'se'   # پیروزیهایم، پیروزیهایت، پیروزیهایش، پیروزیهایمان، پیروزیهایتان، پیروزیهایشان
                            label += 'sf'   # پیروزیهاست
        ...
        ### Adjective ########################################################################################
                    ...
                    if word.endswith(PERSIAN_HE):
                        ...
                        label += 'sa'   # لباس صورتیم، صورتیت، صورتیش، صورتیمان، صورتیتان، صورتیشان
